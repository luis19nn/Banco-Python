...
def efetuar_transferencia() -> None:
    if len(contas) > 0:
        ...
        if conta_o:
            numero_d: float = float(input('Informe o numero da conta destino: '))
            ...
            if conta_d:
                ...
                print(f'Não foi encontrado a conta destino com o número {numero_d}')
        else:
            print(f'Não foi encontrado a sua conta com o número {numero_o}')
    else:
        print('Ainda não existem contas cadastradas!')
